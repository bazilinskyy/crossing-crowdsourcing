...
jsPsych.plugins['video-keyboard-multiple-responses'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('video-keyboard-multiple-responses', 'sources', 'video');

  plugin.info = {
    name: 'video-keyboard-multiple-responses',
    description: '',
    parameters: {
      sources: {
