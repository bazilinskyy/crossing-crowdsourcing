/* jspsych-video-keyboard-response-release.js
...
jsPsych.plugins['video-keyboard-multiple-responses-release'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('video-keyboard-multiple-responses-release', 'sources', 'video');
